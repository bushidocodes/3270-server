...
Legend: **End tag** — whether a closing tag is required. **Tag content** is the tag's text content (the italic entry in IBM's table), or `N/A` if the tag has none. `(body text tags)` abbreviates the recurring help-body set (ATTENTION, CAUTION, DD, FIG, INFO, LI, LINES, LP, NT, PD, WARNING, XMP).

| Tag | End tag | Attributes | Tag content | Nested tags | Used within | Parser support |
|-----|:-------:|------------|-------------|-------------|-------------|----------------|
| **AB** | Yes | MNEMGEN, ABSEPSTR, ABSEPCHAR | N/A | ABC | PANEL | ✅ Supported |
| **ABC** | No | HELP, PDCVAR | choice-description-text | COMMENT, M, PDC, PDSEP, SOURCE | AB | ✅ Supported |
| **ACTION** | No | RUN, PARM, APPLCMD, TYPE, NEWAPPL, NEWWINDOW, PASSLIB, NEWPOOL, SUSPEND, SCRNAME, NOCHECK, ADDPOP, OPT, MODE, LANG, BARRIER, NEST, SETVAR, VALUE, TOGVAR, VALUE1, VALUE2 | N/A | — | CHOICE, PDC | ✅ Supported |
| **AREA** | Yes | MARGINW, MARGIND, INDENT, DEPTH, EXTEND, DIV, DIVWIDTH, FORMAT, TEXT, WIDTH, DIR | N/A | COMMENT, DA, DIVIDER, DTACOL, DTAFLD, GA, GENERATE, GRPHDR, INFO, LSTFLD, PNLINST, REGION, SELFLD, SOURCE | HELP, PANEL | ✅ Supported |
| **ASSIGNI** | No | VALUE, RESULT | N/A | — | ASSIGNL | ❌ #55 |
| **ASSIGNL** | Yes | DESTVAR | N/A | ASSIGNI | DTAFLD | ❌ #55 |
| **ATTENTION** | Yes | — | text | DL, FIG, HP, LINES, NOTE, NOTEL, NT, OL, P, PARML, PS, RP, SL, UL, XMP | LI, LP, P | ❌ #116 |
| **ATTR** | No | ATTRCHAR, TYPE, INTENS, CAPS, JUST, PAD, PADC, SKIP, GE, COLOR, HILITE, NUMERIC, FORMAT, OUTLINE, PAS, CKBOX, CUADYN, CSRGRP, ATTN | N/A | — | DA | ✅ Supported |
...
| **CHECKI** | No | TYPE (RANGE, ALPHA, CHARS, VALUES, PICT, NAME, DSNAME, IDATE, …), PARM1–3 | N/A | — | CHECKL | 🟡 Partial — only RANGE and VALUES implemented — #62 |
| **CHECKL** | Yes | MSG | N/A | CHECKI | VARCLASS | ✅ Supported |
...
| **CMDACT** | No | ACTION | N/A | — | CMD | ✅ Supported |
...
| **CMDTBL** | Yes | APPLID, SORT | N/A | CMD | — | ✅ Supported |
...
| **DA** | Yes | NAME, EXTEND, LVLINE, SCROLL, USERMOD, DATAMOD, DEPTH, WIDTH, SHADOW, DIV, FORMAT, TEXT, SCROLLVAR, SCRVHELP, SCROLLTAB, SCRCAPS, INITATTR, HELP | N/A | ATTR, COMMENT, SOURCE | AREA, PANEL, REGION | ✅ Supported |
...
| **DL** | Yes | TSIZE, BREAK, COMPACT, NOSKIP, INDENT, FORMAT, DIVEND, SPLIT | N/A | DD, DDHD, DLDIV, DT, DTHD, DTDIV, DTHDIV | ATTENTION, CAUTION, DD, FIG, INFO, LI, LINES, LP, NT, PD, WARNING, XMP | ✅ Supported |
...
| **DTACOL** | Yes | PMTWIDTH, ENTWIDTH, DESWIDTH, SELWIDTH, FLDSPACE, PAD, PADC, OUTLINE, PMTFMT, AUTOTAB, ATTRCHANGE, PMTLOC, DBALIGN, VARCLASS, REQUIRED, CAPS, VARDCL | N/A | COMMENT, DIVIDER, DTAFLD, GRPHDR, SELFLD, SOURCE | AREA, PANEL, REGION | ✅ Supported |
| **DTAFLD** | No | NAME, DATAVAR, VARCLASS, HELP, USAGE, REQUIRED, MSG, AUTOTAB, ENTWIDTH, PMTWIDTH, DESWIDTH, ALIGN, PMTLOC, DISPLAY, PAD, OUTLINE, PMTFMT, PSVAR, PSVAL, PAS, CSRGRP, EXPAND, INIT, DEPTH, IMAPNAME, DBALIGN, FLDTYPE, COLOR, INTENS, HILITE, ATTRCHAR, CAPS, AUTOTYPE, VARDCL | prompt-text | ASSIGNL, COMMENT, DTAFLDD, HP, PS, RP, SOURCE, SCRFLD | AREA, DTACOL, PANEL, REGION | ✅ Supported |
| **DTAFLDD** | No | — | description | HP, PS, RP | DTAFLD | ✅ Supported |
| **DTDIV** | No | — | N/A | — | DL | ❌ #120 |
| **DTHD** | No | — | definition-term-header | HP, PS, RP | DL | ❌ #120 |
| **DTHDIV** | No | — | N/A | — | DL | ❌ #120 |
| **DTSEG** | No | — | N/A | — | DT | ❌ #120 |
...
| **GA** | No | NAME, EXTEND, DEPTH, WIDTH, DIV, FORMAT, TEXT, LVLINE | N/A | — | AREA, PANEL, REGION | ❌ #117 |
| **GENERATE** | Yes | SUBSTITUTE | N/A | ATTR, COMMENT, SOURCE | AREA, HELP, PANEL, REGION | ❌ #119 |
...
| **HELPDEF** | No | ID, HELP, WIDTH, DEPTH, CCSID, KEYLIST, APPLID, EXPAND, WINTITLE, APPTITLE, MERGESAREA, IMAPNAME | N/A | — | — | ❌ #54 |
...
| **INFO** | Yes | WIDTH, INDENT | N/A | DIVIDER, DL, FIG, Hn, LINES, NOTE, NOTEL, NT, OL, P, PARML, SL, SOURCE, UL, XMP | AREA, HELP, PANEL, REGION | ✅ Supported |
| **KEYI** | No | KEY, CMD, CASE, FKA, PARM | FKA-text | — | KEYL | ✅ Supported |
| **KEYL** | Yes | NAME, HELP, ACTION, APPLID | N/A | KEYI | — | ✅ Supported |
...
| **LSTFLD** | Yes | RULES, ROWS, DIV, SCROLLVAR, SCRVHELP, SCROLLTAB, SCRCAPS, ATTRCHANGE, VARDCL | N/A | COMMENT, LSTCOL, LSTGRP, LSTVAR, SOURCE | AREA, PANEL, REGION | 🟡 Partial — model rows/scroll not modelled — #67 |
...
| **MSGMBR** | Yes | NAME, CCSID, WIDTH | N/A | COMMENT, MSG | — | ✅ Supported |
| **NOTE** | No | NOSKIP, INDENT, TYPE, COLOR, INTENS, HILITE, TEXT | note-text | HP, PS, RP | (body text tags) | ❌ #116 |
| **NOTEL** | Yes | COMPACT, NOSKIP, SPACE, INDENT, TYPE, COLOR, INTENS, HILITE, TEXT | N/A | LI, LP | (body text tags) | ❌ #116 |
...
| **OL** | Yes | COMPACT, NOSKIP, SPACE, INDENT, TEXT | N/A | LI, LP | (body text tags) | ✅ Supported |
| **P** | No | COMPACT, INTENSE, INDENT, OFFSET, SPACE | paragraph-text | ATTENTION, CAUTION, HP, PS, RP, WARNING | (body text tags) | ✅ Supported |
| **PANDEF** | No | ID, HELP, DEPTH, WIDTH, KEYLIST, CCSID, WINDOW, WINTITLE, APPTITLE, PAD, OUTLINE, EXPAND, MERGESAREA, ENTKEYTEXT, IMAPNAME, TMARGIN, BMARGIN | N/A | — | — | ❌ #117 |
| **PANEL** | Yes | NAME, HELP, PANDEF, DEPTH, WIDTH, KEYLIST, CURSOR, CCSID, MENU, PRIME, TUTOR, WINDOW, WINTITLE, PAD, OUTLINE, EXPAND, MSGLINE, TITLINE, CMDLINE, TYPE, ACTBAR, ENTKEYTEXT, IMAPNAME, TMARGIN, BMARGIN, ERRORCHECK, ZUP, ZCONT | panel-title-text | AB, AREA, BOTINST, CMDAREA, COMMENT, DA, DIVIDER, DTACOL, DTAFLD, GA, GENERATE, GRPHDR, HP, INFO, LSTFLD, PNLINST, REGION, SELFLD, SOURCE, TEXTLINE, TOPINST | — | ✅ Supported |
| **PARML** | Yes | TSIZE, BREAK, COMPACT, SKIP, INDENT, FORMAT, DIVEND, SPLIT | N/A | PLDIV, PT, PTDIV, PD | (body text tags) | ✅ Supported |
...
| **SCRFLD** | Yes | DISPLEN, INDVAR, INDVAL, LINDVAR, RINDVAR, SINDVAR, LCOLIND, RCOLIND, SCALE, SCROLL, FLDSPOS | N/A | COMMENT, SOURCE | DTAFLD, LSTCOL | ❌ #115 |
...
| **SL** | Yes | COMPACT, NOSKIP, SPACE, INDENT, TEXT | N/A | LI, LP | (body text tags) | 🟡 Partial — transparent container; LI renders, SL packing not modelled |
...
| **T** | No | — | N/A | — | CMD | ❌ #118 |
| **TEXTLINE** | Yes | — | N/A | DTAFLD, TEXTSEG | HELP, PANEL | ❌ #117 |
| **TEXTSEG** | No | EXPAND, WIDTH | text | HP | TEXTLINE | ❌ #117 |
| **TOPINST** | No | COMPACT | instruction-text | HP, PS, RP | PANEL | ✅ Supported |
| **UL** | Yes | COMPACT, NOSKIP, SPACE, INDENT, TEXT | N/A | LI, LP | (body text tags) | ✅ Supported |
| **VARCLASS** | No | NAME, TYPE, MSG | N/A | CHECKL, XLATL | — | ✅ Supported |
| **VARDCL** | No | NAME, VARCLASS | N/A | — | VARLIST | ✅ Supported |
| **VARLIST** | Yes | — | N/A | VARDCL | — | ✅ Supported |
| **VARSUB** | No | VAR | N/A | — | MSG | ❌ #118 |
...
| **XLATL** | Yes | FORMAT, TRUNC, MSG | N/A | XLATI | VARCLASS | ❌ #114 |
